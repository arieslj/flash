select
    ...
    ,'' 客户处理状态
    ,'拒收策略-由商户决定' 类型
from my_staging.ka_diff_ticket kdt
-- left join my_staging.customer_diff_ticket cdt on cdt.diff_info_id = kdt.diff_info_id
left join my_staging.diff_info di on di.id = kdt.diff_info_id
