...
(
    ...
    left join dwm.tmp_ex_big_clients_id_detail bc on bc.client_id = cdt.client_id and bc.client_name = 'lazada'
    where
...
distinct
    ...
    ,if(cdt.state = 2, '是', '否') 是否沟通完成
    ,if(cdt.state = 2, convert_tz(cdt.updated_at, '+00:00', '+08:00'), null) 沟通时间
    ,convert_tz(cdt.first_operated_at, '+00:00', '+08:00') first_operated_at
...
and cdt.created_at>=date_sub(convert_tz('${sdate}','+08:00','+00:00'),interval 6 hour)
and cdt.created_at<=date_add(convert_tz('${edate}','+08:00','+00:00'),interval 18 hour)
and (bc.client_id is null or bc.client_name != 'lazada')
