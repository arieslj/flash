...
(
        ...
        WHERE p_date>='2023-03-01' and p_date<'2023-04-01'
            AND
                (
...
left join
    (
        ...
        where
            swa.p_date between '2023-03-01' and '2023-03-31'
...
left join
    (
        ...
        where
            pi.p_date between '2023-03-01' and '2023-03-31'
        group by
