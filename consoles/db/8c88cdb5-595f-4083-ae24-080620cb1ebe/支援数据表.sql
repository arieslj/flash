...
(
    ...
    join backyard_pro.staff_work_attendance swa on hsa.sub_staff_info_id = swa.staff_info_id and swa.attendance_date = '${date}' and swa.organization_id = hsa.store_id and ( swa.started_at is not null  or swa.end_at is not null )
    where
