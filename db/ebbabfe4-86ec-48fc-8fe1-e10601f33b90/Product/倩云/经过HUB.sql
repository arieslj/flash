...
left join dwm.parcel_store_stage_new pssn on pssn.pno = a1.pno and pssn.valid_store_order is not null and pssn.created_at > a1.created_at and pssn.created_at <= a1.finished_at and pssn.store_category in (8,12)
;
...
left join dwm.parcel_store_stage_new pssn on pssn.pno = a1.pno and pssn.valid_store_order is not null and pssn.first_valid_routed_at > a1.created_at and pssn.first_valid_routed_at <= a1.finished_at and pssn.store_category in (8,12)
group by 1
;