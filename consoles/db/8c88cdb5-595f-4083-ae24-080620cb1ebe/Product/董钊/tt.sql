...
, val as
    (
        select
            ...
            ,p1.state
            ,case
                when t1.client_name = 'tiktok' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) < 2000 then coalesce(oi.cogs_amount/100, p2.cod_amount/100)
                when t1.client_name = 'tiktok' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) >= 2000 then 2000
                when t1.client_name = 'lazada' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) < 6000 then coalesce(oi.cogs_amount/100, p2.cod_amount/100)
                when t1.client_name = 'lazada' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) >= 6000 then 6000
                when t1.client_id in ('AA0386','AA0425','AA0427','AA0569','AA0771','AA0731','AA0657','AA0707','AA0736','AA0838') and coalesce(oi.cogs_amount/100, p2.cod_amount/100) < 2000 then coalesce(oi.cogs_amount/100, p2.cod_amount/100)
                when t1.client_id in ('AA0386','AA0425','AA0427','AA0569','AA0771','AA0731','AA0657','AA0707','AA0736','AA0838') and coalesce(oi.cogs_amount/100, p2.cod_amount/100) >= 2000 then 2000
                when t1.client_id in ('AA0572', 'AA0574', 'AA0606', 'AA0612') and coalesce(oi.cogs_amount/100, p2.cod_amount/100) < 15000 then coalesce(oi.cogs_amount/100, p2.cod_amount/100)
                when t1.client_id in ('AA0572', 'AA0574', 'AA0606', 'AA0612') and coalesce(oi.cogs_amount/100, p2.cod_amount/100) >= 15000 then 15000
                when t1.client_name = 'shopee' and t1.client_id not in ('AA0572', 'AA0574', 'AA0606', 'AA0612','AA0386','AA0425','AA0427','AA0569','AA0771','AA0731','AA0657','AA0707','AA0736','AA0838') then if(coalesce(oi.cogs_amount/100, p2.cod_amount/100) > 2000, 2000, coalesce(oi.cogs_amount/100, p2.cod_amount/100))
                when t1.client_id = 'AA0306' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) < 5000 then coalesce(oi.cogs_amount/100, p2.cod_amount/100)
                when t1.client_id = 'AA0306' and coalesce(oi.cogs_amount/100, p2.cod_amount/100) >= 5000 then 5000
