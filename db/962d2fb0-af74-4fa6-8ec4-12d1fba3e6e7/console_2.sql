...
(
        ...
        WHERE p_date>='2023-08-01' and p_date<'2023-09-01'
            AND
                (
...
left join
    (
        ...
        where
            swa.p_date between '2023-08-01' and '2023-08-28'
...
left join
    (
        ...
        where
            pi.p_date between '2023-08-01' and '2023-08-28'
        group by
...
left join
    (
        ...
        where
            ...
            and pi.state = '5'
            and pi.finished_at >= '2023-08-01'
            and pi.finished_at < '2023-09-01'
        group by
