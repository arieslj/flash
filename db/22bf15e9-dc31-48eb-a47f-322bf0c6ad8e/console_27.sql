...
left join dwm.dwd_dim_dict ddd2 on ddd2.element = di.rejection_category and ddd.db = 'fle_staging' and ddd2.tablename = 'diff_info' and ddd2.fieldname = 'rejection_category'
