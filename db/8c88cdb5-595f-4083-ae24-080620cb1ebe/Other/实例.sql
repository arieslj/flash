...
from tmpale.tmp_th_staff_base_data t
left join
(
 select
  t.staff_id
  ,count() ct
 from tmpale.tmp_th_staff_base_data t
 where t.p_date>=date_sub(current_date,interval 8 day)
 and t.p_date<'2023-11-17'
 group by 1
)staff on staff.staff_id=t.staff_id

where t.p_date='2023-11-17'
order by store
