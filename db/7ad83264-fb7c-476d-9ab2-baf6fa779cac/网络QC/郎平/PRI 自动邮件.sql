...
select
    pp.pno
    ,count(distinct pp.screening_date) cnt
from ph_staging.parcel_priority_delivery_detail pp
# where
#     pp.screening_date > '2024-07-01'
group by pp.pno
having count(distinct pp.screening_date) > 1
...
select
    *
from tmpale.tmp_ph_report_reason
