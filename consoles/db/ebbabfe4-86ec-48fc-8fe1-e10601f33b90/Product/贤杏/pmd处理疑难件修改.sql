...
(
    ...
    and di.diff_marker_category not in (2,17,32,69,7,22,28)
...
left join dwm.dwd_dim_dict ddd on ddd.element = di.diff_marker_category and ddd.fieldname = 'diff_marker_category' and ddd.db = 'my_staging' and ddd.tablename = 'diff_info'
where
    di.pno = 'MT10031WUC9K0Z'
#     cdt.client_id in ( 'AA0076', 'AA0077')
#     and vip_enable = 0
#     and di.diff_marker_category not in (17,39)
