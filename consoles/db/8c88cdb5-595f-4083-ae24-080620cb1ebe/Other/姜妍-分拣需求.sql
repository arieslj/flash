        ...
        (
            ...
            from
                (
                    ...
                    left join dwm.drds_parcel_sorting_code_info dp on ds.pno = dp.pno and ds.dst_store_id = dp.dst_store_id
                    join rot_pro.parcel_route pr on pr.pno = dp.pno and pr.route_action = 'SORTING_SCAN' and pr.routed_at >= '2023-08-22 17:00:00' and pr.routed_at < '2023-08-23 17:00:00'
                    where
...
left join dwm.dim_th_sys_store_rd dt on dt.store_id = t1.dst_store_id and dt.stat_date = date_sub(curdate(), interval 1 day)
...
;
 ...
 select
        ...
        ,a.staff_info_id
        ,convert_tz(a.routed_at, '+00:00', '+07:00') 分拣时间
    ...
    left join dwm.dim_th_sys_store_rd dt on dt.store_id = a.dst_store_id and dt.stat_date = date_sub(curdate(), interval 1 day)
    where
        a.rk = 1
        and a.dst_store_id in ('TH06011101','TH20070702','TH01230105','TH68130100','TH01140303','TH07060701')


 ;

lazada时效表 whole_end_date
shoppe丢失时效表 end_date

shein  whole_end_date
