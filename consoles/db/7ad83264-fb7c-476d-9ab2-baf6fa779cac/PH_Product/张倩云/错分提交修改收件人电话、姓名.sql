with t as
    (
        ...
        where
            di.created_at > '2024-04-28 16:00:00'
            and di.created_at < '2024-05-05 16:00:00'
...
, s as
    (
        ...
        where
            ...
            and pr.routed_at < date_add(t1.di_date, interval 16 hour)
            and pr.routed_at > date_sub(t1.di_date, interval 8 hour)
    )
select
    t1.pno
    ,a2.store_id 首次上报网点
