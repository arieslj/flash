...
(
        ...
        WHERE p_date>='2023-02-01' and p_date<'2023-03-01'
            AND
                (
...
left join
    (
        ...
        where
            swa.p_date between '2023-01-01' and '2023-02-28'
...
left join
    (
        ...
        where
            pi.p_date between '2023-01-01' and '2023-02-28'
        group by
...
left join
    (
        ...
        where
            ...
            and pi.state = '5'
            and pi.finished_at >= '2023-01-01'
            and pi.finished_at < '2023-03-01'
        group by
