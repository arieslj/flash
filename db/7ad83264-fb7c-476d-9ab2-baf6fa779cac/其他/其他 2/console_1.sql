...
;
# select left(sa.object_key,26) from ph_backyard.sys_attachment sa where  sa.id = 'f4466fd8fac9de316946d9d0a64340c1's

select
    date(convert_tz(pr.routed_at, '+00:00', '+08:00')) date_d
    ,count(distinct  pr.pno)
from ph_staging.parcel_route pr
where
    pr.store_id = 'PH04470200'
    and pr.route_action = 'SHIPMENT_WAREHOUSE_SCAN'
    and pr.routed_at >= '2023-08-31 16:00:00'
    and pr.routed_at < '2023-09-30 16:00:00'
group by 1