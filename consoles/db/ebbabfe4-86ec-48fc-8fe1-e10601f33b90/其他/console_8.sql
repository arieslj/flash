...
# 		                            and pr.routed_at < date_add(curdate(), interval 9 hour)
		                            pr.routed_at >= '2023-09-14 16:00:00'
		                            and pr.routed_at < '2023-09-15 09:00:00'
...
# 		                            and pr.routed_at < date_add(curdate(), interval 10 hour)
		                            pr.routed_at >= '2023-09-14 16:00:00'
		                            and pr.routed_at < '2023-09-15 10:00:00'
		                            and pr.route_action in ('DELIVERY_TICKET_CREATION_SCAN')
		                            and hsi.job_title in(13,110,1199)
		                            and hsi.formal=1
		                    ) pr
...
# 				    ,f1.负责人
					...
					,if(f2.交接包裹妥投量_非退件妥投/f2.交接量_非退件<0.7 and f2.交接包裹妥投量_非退件妥投<70 and (hour(f6.finished_at)<15 or f6.finished_at is null ),'是',null) as 是否低人效
...
# 						    and pi.finished_at< date_add(curdate(), interval 10 hour)
				            and pi.finished_at >= '2023-09-14 16:00:00'
					        and pi.finished_at < '2023-09-15 10:00:00'
				        )ha
				        where ha.rk=1
