     /*
        =====================================================================+
        表名称：1586d_th_kam_cn_th_diff_data
        功能描述：过去31天内提交的问题件工单数据
...
left join tmpale.tmp_th_client_id_cn_th_v2 t on cdt.client_id = t.client_id
...
where
    ...
    cdt.created_at >= '2024-06-30 17:00:00'
    and cdt.created_at < '2024-07-31 17:00:00'
    and t.projectteam not in ('LZD', 'SPX', 'TikTok')
    and cdt.organization_type = 2
    and cdt.vip_enable = 1
   -- and cdt.state not in (1,5)
    and (t.client_id is not null or cdt.client_id in ('CBA9147','BG2393','BG2383','BG2396','BA2403','BG2398','BG2398','BG2361','BG2369','BG2382','BG2252'))
