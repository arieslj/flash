...
from
    (
        select
            ...
            ,coalesce(a1.duty_department, a2.duty_department, a3.duty_department, a4.duty_department, a6.duty_department, a7.duty_department, a8.duty_department, a9.duty_department, a10.duty_department, a11.duty_department, a12.duty_department, t1.last_valid_store_category) 负责部门
        from t t1
