...
select
    ...
    ,case
        when cdt.created_at > '2024-08-20 17:00:00' and cdt.created_at < '2024-09-21 17:00:00' then '0821-0921'
        when cdt.created_at > '2024-09-21 17:00:00' and cdt.created_at < '2024-10-21 17:00:00' then '0922-1022'
    end 时间段
...
where
    cdt.created_at > '2024-08-20 17:00:00'
    and cdt.created_at < '2024-10-21 17:00:00'
...
from t t1
join fle_staging.diff_ticket_complain_false_info dtc on dtc.customer_diff_id = t1.id
group by 1,2,3
