...
left join dwm.drds_my_parcel_route_extra dp on dp.route_extra_id = json_extract(pr.extra_value, '$.routeExtraId') and  dp.created_at > '2024-12-30 01:00:00'
left join dwm.dim_my_sys_store_rd dt on dt.store_id = pr.store_id and dt.stat_date = date_sub(curdate(), interval 1 day)
where
